  ...
  return (
    <div className="relative">
      ...
      <div className='flex justify-center items-center'>
        <Link to = {"/products"} className = 'group flex items-center gap-2 px-4 md:px-6 py-2 bg-green-600 hover:bg-green-900 transition rounded text-sm text-white cursor-pointer'>
          Shop Now 
