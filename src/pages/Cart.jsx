...
const Cart = () => {
    ...
    const {products, currency, cartItems, removeFromCart, getCartCount, updayeCartItem, navigate, getCartAmount} = useAppContext()
                            ...
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        <p>Qty:</p>
                                        <select onClick={e => updayeCartItem(product._id, Number(e.target.value))}
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{selectedAddress ? `${selectedAddress.street} ${selectedAddress.city} ${selectedAddress.state} ${selectedAddress.city}` : "No address found"}</p>
