    ...
    return product && (
        <div className="mt-12">
           ...
           <div className="flex flex-col items-center w-max ">
            ...
            <div className="w-20 h-0.5 bg-amber-800 rounded-full mt-2">
            </div>
           </div>
           ...
           <button  onClick={()=>{navigate('/products'); scrollTo(0,0)}}  className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-blue-400 hover:bg-amber-200 transition">See more</button>
          </div>    
        </div>
    );
};
